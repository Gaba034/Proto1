      ...
      <div>
        <article class="main">
          <div id="news">
            ...
            {{news2}}
            <br>
            <img width="700px"  class="frame" src="https://pbs.twimg.com/media/FIc7ONWWQAk-cZX?format=jpg&name=large" alt="">
            <br>
            <img width="700px"  class="frame" src="https://pbs.twimg.com/media/FIc7ONUXIAgv_eN?format=jpg&name=large" alt="">
            <br>
            {{news3}}
            <br>
            <div class="imgvid">
              <iframe class="frame" src="https://streamable.com/e/acqnv0" frameborder="0" allowfullscreen style="width: 500px; height: 300px; padding:0px;"></iframe>
              <br>
              <img  class="frame" src="https://pbs.twimg.com/media/FJAjJsyXEAAb1l7?format=jpg&name=360x360" style="width: 400px; height: 300px; padding-left:0px;" alt="">
              <div  style="width: 100%; height: 0px; position: relative; padding-bottom: 28%;"><iframe class="frame" src="https://streamable.com/e/higvad" frameborder="0" width="300px" height="300px" allowfullscreen style="width: 200px; height: 300px; position: absolute;"></iframe></div>
            </div>
          </div>
          <div id="about">
            <h1>Sobre</h1>
...
export default {
  ...
  async mounted() {
    ...
    if (gameProfile.docs.length > 0) {
      ...
      this.news2 = roblox.data().news2;
      this.news3 = roblox.data().news3;
  ...
  methods: {
    async searchCodes() {
      this.codigos = [];
      const logCode = await fb.tasksCollection
