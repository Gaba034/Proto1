...
export default {
  ...
  async mounted() {
    ...
    if (gameProfile.docs.length > 0) {
      ...
      this.new3 = roblox.data().new3;
      this.new4 = roblox.data().new4;
      this.new5 = roblox.data().new5;
      this.new6 = roblox.data().new6;
      this.new7 = roblox.data().new7;
      this.new8 = roblox.data().new8;
      this.new9 = roblox.data().new9;
      this.new10 = roblox.data().new10;
      this.new11 = roblox.data().new11;
      this.new12 = roblox.data().new12;
      this.new13 = roblox.data().new13;
      this.new14 = roblox.data().new14;
  ...
  methods: {
    async searchCodes() {
      this.codigos = [];
      const logCode = await fb.tasks6Collection
